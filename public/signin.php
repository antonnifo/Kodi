							   ...
							   <div class="over_lay_agile_pages_w3ls">
								    <div class="registration">
												...
												<div class="signin-form profile">
													<h2>Accused Person Sign in Page</h2>
...
// If form submitted, insert values into the database.
    if (isset($_POST['national_id'])) {
        // removes backslashes
		$national_id = stripslashes($_REQUEST['national_id']);
        //escapes special characters in a string
		$national_id = mysqli_real_escape_string($con, $national_id);
		$password = stripslashes($_REQUEST['password']);
		$password = mysqli_real_escape_string($con, $password);
		//Checking  is user existing in the database or not

    	$query = "SELECT * FROM `accused` WHERE national_id='$national_id'
        ...
        echo "
			<h3>national_id/password is incorrect.</h3>
